<?php 
	...
	///
	/// Skrypt do oceniania pracodawców
	///
...
<body>
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    <?php
						...
						///
						/// Jeśli klient zalogowany może sprawdzić swoje konto, wystawić oceny lub wylogować się.
						///
                    ?>
					...
					///
					/// Jeśli klient nie jest zalogowany przenosi go do strony logowania
					///	
                    ?>
                    <a class="nav-link dropdown-toggle" id="navbarDropdownMenuLink-4" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    ...
    <div class="container">
        ...
        <?php
		///
		/// Jeśli klient ciągle zalogowany może wystawić ocenę, jeśli nie przenosi do strony głównej.
		///
        if(Sessions::isLogged()){
