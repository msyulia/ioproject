<?php 
	...
	///
	/// Sprawdza czy klient zalogowany jeśli tak to wyświetla główną stronę
	/// 
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item dropdown">
                    <?php
                        if(Sessions::isLogged()){
						///
						/// Sprawdza czy klient ciągle zalogowany. Jeśli tak to może sprawdzić swoje konto, wystawić oceny lub się wylogować.
						///
                    ?>
					...
					///
					/// Jeśli nie, to odsyła go do strony logowania.
					///
