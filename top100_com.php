...
<body>
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    <?php
						...
						///
						/// Jeśli klient zalogowany może sprawdzić swoje konto, wystawić oceny lub się wylogować
						///	
					...
					///
					/// Jeśli nie zalogowany przenosi do strony logowania
					///		
    ...
    <?php
		///
		/// Dodaje rekordy do bazy top pracodawców.
		///
