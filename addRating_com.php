...
///
///	Sprawdza czy klient zalogowany, jesli tak przechodzi do strony gdzie może wyszukać pracodawców
///
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent-4">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
					...
					///
					/// Wstawka sprawdzająca czy klient zalogowany, jeśli jest to może sprawdzić swoje konto, wystawić oceny lub się wylogować
					///
					...
					///
					/// Jeśli klient nie jest zalogowany przenosi go do pola logowania
					///
...
<div class="container">
    ...
    <?php echo $_POST['pracodawca'];
		...
		///
		/// Wystawianie oceny dla konkretnego pracodawcy biorąc pod uwagę takie cechy jak: wynagrodzenia, atmosferę, benefity, miejsce pracy i możliwość rozwoju. Można rónież dodać swoją opinię.
		///
